#include <iostream>
#include "doubleHashProbe.h"
#include "hashProbe.h"
int main()
{
    if (true)
    {
        std::cout << "Hash Probes: Ints and Chars Linear" << std::endl;
        cop3530::hashProbe<int, char> h(20, 'l');
    ...
    if (true)
    {
        std::cout << "Hash Probes: Ints and Chars Quadratic" << std::endl;
        cop3530::hashProbe<int, char> h(23, 'q');
        std::cout << "Capacity: " << h.capacity() << std::endl;
        h.insert(10, 'A');
        h.insert(10, 'B');
        char x;
    ...
    if (true)
    {
        std::cout << "Hash Probes: Ints and Chars Double Hashing" << std::endl;
        cop3530::doubleHashProbe<int, char> h(128);
        std::cout << "Capacity: " << h.capacity() << std::endl;
        h.insert(10, 'A');
        h.insert(10, 'B');
        char x;
        ...
        std::cout << h.insert(12, 'D') << std::endl;
        std::cout << h.search(12, x) << std::endl;
        std::cout << h.remove(17, x) << std::endl;
        std::cout << h.remove(19, x) << std::endl;
        h.print(std::cout);
        std::cout << std::endl;
        h.cluster_distribution(std::cout);
        std::cout << std::endl;
    ...
    if (true)
    {
        std::cout << "Hash Probes: Doubles and Ints" << std::endl;
        cop3530::hashProbe<double, int> h(20);
        ...
        h.print(std::cout);
        std::cout << std::endl;
        std::cout << "Number of Probes to Insert: " << h.insert(1.4, 25) << std::endl;
        int x;
        std::cout << "Number of Probes to Search: " << h.search(1.4, x) << std::endl;
        std::cout << x << std::endl;
        for (unsigned int i=0; i<h.size(); ++i)
        {
            h.remove_random();
